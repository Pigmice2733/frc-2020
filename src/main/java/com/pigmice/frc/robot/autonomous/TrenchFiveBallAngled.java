...
import com.pigmice.frc.robot.autonomous.tasks.UnJam;
import com.pigmice.frc.robot.subsystems.Drivetrain;
import com.pigmice.frc.robot.subsystems.Feeder;
import com.pigmice.frc.robot.subsystems.Intake;
import com.pigmice.frc.robot.subsystems.Shooter;

public class TrenchFiveBallAngled extends Autonomous {
    public TrenchFiveBallAngled(Drivetrain drivetrain, Shooter shooter, Feeder feeder, Intake intake) {
        ...
        this.subroutines = Arrays.asList(acquisition, returnAndSpinUp, new UnJam(intake, 1.0),
                new Shoot(shooter, feeder, intake, 5.0, 120));
    }
    ...
    public static PathFollower constructReturnPath(Drivetrain drivetrain, Shooter shooter, Intake intake,
        ...
        positions.add(new Point(-0.2, -1.4));
        positions.add(new Point(1.0, -0.4));
        positions.add(new Point(1.5, 0.3));
        positions.add(new Point(2.0, 1.0));
        ...
        follower.addAction(0, 0, powerCellAcquisition);
        follower.addAction(1, 1, backFeed);
        follower.addAction(2, 4, spinUp);
